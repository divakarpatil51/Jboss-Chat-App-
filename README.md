Sample_Login_app: Kitchensink Example using Spring 4.x
==============================================================
Author: Marius Bogoevici, Tejas Mehta, Joshua Wilson  
Level: Intermediate  
Technologies: JSP, JPA, JSON, Spring, JUnit  
Summary: The `Sample_Login_app` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x.  
Target Product: WFK  
...
The `Sample_Login_app` quickstart is an example of a Java EE 6 application using JSP, JPA 2.0 and Spring 4.x. It 
...
4. This will deploy `target/Sample_Login_app.war` to the running instance of the server.


Access the application
----------------------

The application will be running at the following URL: <http://localhost:8080/Sample_Login_app/>.
